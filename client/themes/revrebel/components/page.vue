...
.page-header-section {
  ...
  .page-edit-shortcuts {
    ...
    .v-btn {
      border-right: 1px solid var(--color-rev-inverse-dark) !important;
      border-bottom: 1px solid var(--color-rev-inverse-dark) !important;
      border-radius: 0;
      ...
      @at-root .theme--dark & {
        ...
        border-bottom-color: var(--color-rev-dark);
